...
EMAIL_FROM="DC / dr. croley <your-email@example.com>"
```

For Gmail or Google Workspace, use an app password, not your normal password. If your domain email is hosted somewhere else, use that provider's SMTP host, port, username, and password.
